...
const ThemeToggle: React.FC<ThemeToggleProps> = ({ isVisible }) => {
  ...
  return (
    <div
      ...
      } md:flex flex-row items-center w-full gap-4 mt-6 md:mt-0 md:py-8 md:px-5 md:outline-1 md:outline-secondary-300 md:dark:outline-secondary-dark-300`}
    >
      <button
          ...
          >
            {darkMode ? (
              ...
              >
                ...
                />
                <path
                  d="M16 7.47598H14.2207V8.52206H16V7.47598Z"
                  fill="white"
                />
                <path
